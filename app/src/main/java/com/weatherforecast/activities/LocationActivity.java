...
public class LocationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabAdd.setOnClickListener(view -> checkNetworkAndCall(this::showAddPlaceDialog, false));
    }
    ...
    private void showAddPlaceDialog() {
        ...
        btSearch.setOnClickListener(view1 -> {
            ...
            try {
                List<Address> addresses = geocoder.getFromLocationName(placeName, 10);
                if (addresses.size() == 0) {
                ...
                for (int p = 0; p < addresses.size(); p++) {
                    ...
                    String placeAddress = address.getLocality() + ", " + address.getAdminArea() + ", " + address.getCountryName();
